//   c47b3d4dfdb2ba896f1c7d55d55d9fb4034cc2c7
// --
...
func WebRPCSchemaHash() string {
	return "c47b3d4dfdb2ba896f1c7d55d55d9fb4034cc2c7"
}
...
func (s *aPIServer) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	switch r.URL.Path {
	case "/rpc/API/GetMapTiles":
		s.serveGetMapTiles(ctx, w, r)
		return
	default:
...
func (s *aPIServer) serveGetMapTiles(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	...
	case "application/json":
		s.serveGetMapTilesJSON(ctx, w, r)
	default:
...
func (s *aPIServer) serveGetMapTilesJSON(ctx context.Context, w http.ResponseWriter, r *http.Request) {
	var err error
	ctx = context.WithValue(ctx, MethodNameCtxKey, "GetMapTiles")
	...
	func() {
		...
		ret0, err = s.API.GetMapTiles(ctx)
	}()
	respContent := struct {
		Ret0 []*MapTile `json:"tiles"`
	}{ret0}
