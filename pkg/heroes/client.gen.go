...
func WebRPCSchemaHash() string {
	return "da869ec8928e3d8ecf7b20dacc8d8e3ab13a097e"
}
...
func (c *aPIClient) GetMap(ctx context.Context, filename string) (*Map, error) {
	in := struct {
...
func (c *aPIClient) ListMaps(ctx context.Context) ([]string, error) {
	out := struct {
